...
//                 const vm = vnode.context;
//                 document.onclick = function(e){
//                     const falg = el.contains(e.target)
//                     if(falg && !vm.showPage){
//                         vm.isShow(true)
//                     }else if(!falg && vm.showPage){
//                         vm.isShow(false)
//                     }
//                 }
...
//         },
//         getShowDate(date){
//             const {year,month,day,week} = this.yearMonthDay(date)
//             this.showDates = {year,month,day,week}
//         },
//         yearMonthDay(date){
//             const year = date.getFullYear();
//             const month = date.getMonth();
...
//            const {year:chooseYear,month:chooseMonth,day:chooseDay} = this.yearMonthDay(chooseDate);
//             const {year:curYear,month:curMonth,day:curDay} = this.yearMonthDay( new Date() );
//            const {year:theYear,month:theMonth} = this.showDates;
//            const {year,month,day} = this.yearMonthDay(date);

//            return {
//                month:year === theYear && month !== theMonth,
//                chooseDay:day === chooseDay && year === chooseYear && month === chooseMonth,
...
//         },
//         changeMonth(num){
//             this.showDates.month += num;
//             if(this.showDates.month > 11){
//                 this.showDates.month = 0;
//                 this.showDates.year += 1;
//             }else if(this.showDates.month < 1){
//                 this.showDates.month = 11;
//                 this.showDates.year -= 1;
//             }
            
//         },
//         changeYear(num){
//            this.showDates.year += num;
//         }
//     },
...
//        showDay(){
//            let arr =[];
//            const {year,month} = this.showDates;
//            const firstDay = new Date(year,month,1);
//            const week = firstDay.getDay();
//            for(let i=0;i<42;i++){
//               arr.push(new Date( +firstDay + (i-week)*24*60*60*1000 ));
